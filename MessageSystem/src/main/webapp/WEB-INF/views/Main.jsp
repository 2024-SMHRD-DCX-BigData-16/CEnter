			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						...
						<nav>
							...
							<c:if test="${loginuser.email eq '래우' }">
								<a href="showMember">전체회원조회</a>
				...
				<!-- Menu -->
					<nav id="menu">	
						<ul class="links">
						<!-- Q3. 로그인 기능 만들기 -->
						<!-- main페이지에서 요청 -> controller에서 입력받은 email, pw 출력 -->
							<li><h5>로그인</h5></li>
						...
						<!-- Q1. 회원가입 기능 만들기 -->
							<li><h5>회원가입</h5></li>
								<form action="memberInsert" method="post">
									...
									<li><input type = "button" value="Email 중복체크" onclick="emailCheck()"></li>
				...
				<!-- Main -->
					...
					<!-- Two -->
						 ...
						 <c:choose>
                           ...
                           <c:otherwise>
                              <li>${loginuser.email}님에게 온 메세지</li>
                              <table>
					...
					<section id="contact">
						<div class="inner">
							...
							<!-- 다른 사람의 DB에 메시지 저장해보기! -->
								<form action = "messageSend" method="get">
								<div class="field half first">
										<label for="name">Name</label>
										<c:if test="${loginuser != null }">
											<input type="text"  id="name" placeholder="보내는 사람 이름" name ="sendE" value="${loginuser.email }" />
										</c:if>
										<c:if test="${loginuser == null }">
											<input type="text"  id="name" placeholder="보내는 사람 이름" name ="sendE" value="sendE" />
										</c:if>
									</div>
